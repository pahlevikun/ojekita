...
public class CarServiceActivity  extends AppCompatActivity implements OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mapFragment.getMapAsync(CarServiceActivity.this);
...
//        getLocation(gps.getLatitude(),gps.getLongitude());
    ...
    private class DownloadTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            CarServiceActivity.ParserTask parserTask = new CarServiceActivity.ParserTask();
    ...
    private void makeJsonObjectRequest() {
        ...
        StringRequest jsonObjReq = new StringRequest(Request.Method.GET, APIConfig.API_GET_DRIVER, new Response.Listener<String>() {
                ...
                try {
                    ...
                    if (!error) {
                        ...
                        try {
                            ...
                            Toast.makeText(CarServiceActivity.this, e.toString(), Toast.LENGTH_LONG).show();
                        }
                    }
                } catch (JSONException e) {
                    Toast.makeText(CarServiceActivity.this, ""+e, Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onErrorResponse(VolleyError error) {
                hideDialog();
                Toast.makeText(CarServiceActivity.this, ""+error, Toast.LENGTH_SHORT).show();
            }
        }){
            @Override
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (!error) {
                        ...
                        Intent intent = new Intent(CarServiceActivity.this, LoadingScreenActivity.class);
                        ...
                        final AlertDialog.Builder alert = new AlertDialog.Builder(CarServiceActivity.this);
                        alert.setTitle("Peringatan");
        ...
        StringRequest jsonObjReq = new StringRequest(Request.Method.POST, APIConfig.API_ORDER_CANCEL, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    boolean error = jObj.getBoolean("error");
                    if (!error) {
                        Intent intent = new Intent(CarServiceActivity.this, MainActivity.class);
